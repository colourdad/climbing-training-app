...
function useStore() {
  ...
  // ---- exercise customizations (per-session order + skipped) ----
...
const Icon = {
  ...
  DragHandle: (p) => <svg viewBox="0 0 20 20" fill="currentColor" {...p}><rect x="3" y="4" width="14" height="2" rx="1" /><rect x="3" y="9" width="14" height="2" rx="1" /><rect x="3" y="14" width="14" height="2" rx="1" /></svg>,
};

// ============================================================================
// SwipeDeleteRow — swipe left to reveal/trigger remove
// ============================================================================
function SwipeDeleteRow({ children, onDelete, disabled }) {
...
// ============================================================================
// SortableList — drag handle to reorder + optional swipe-to-delete
// ============================================================================
function SortableList({ items, keyFn, renderItem, onReorder }) {
  ...
  React.useEffect(() => {
    ...
    const handleMove = (e) => {
      ...
      const newOver = Math.max(0, Math.min(itemsRef.current.length - 1,
...
// Day row
// ============================================================================
function DayRow({ day, isToday, status, onClick, editMode, onDragHandleTouch }) {
...
// ============================================================================
function ExerciseCard({ ex, done, onToggleDone, expanded, onToggleExpand, onDragHandleTouch }) {
  return (
